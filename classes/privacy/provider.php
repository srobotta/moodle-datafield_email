...
/**
 * Privacy Subsystem implementation for datafield_email.
 *
...
namespace datafield_email\privacy;
...
class provider implements datafield_provider, null_provider {
    ...
    public static function export_data_content($context, $recordobj, $fieldobj, $contentobj, $defaultvalue) {
        $defaultvalue->field['mailtolink'] = transform::yesno($fieldobj->param1);
        $defaultvalue->email = $contentobj->content;
